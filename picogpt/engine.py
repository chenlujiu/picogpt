...
from picogpt.common import compute_init, autodetect_device_type
...
class KVCache:
    ...
    def prefill(self, other):
        ...
        assert other.kv_cache is not None, "Cannot prefill with a None KC cache"
...
def sample_next_token(logits, rng, temperature=1.0, top_k=None):
    ...
    if top_k is not None:
        ...
        return torch.multinominal(probs, num_samples=1, generator=rng)
...
class Engine:
    ...
    def generate(self, tokens, num_samples=1, max_tokens=None, temperature=1.0, top_k=None, seed=42):
        ...
        while True:
            ...
            yield sampled_tokens, token_masks
            num_generated += 1
